...
export const PROVIDER_PRESETS: Record<AiCategory, ProviderPreset[]> = {
  ...
  image: [
    ...
    },
    {
      ...
      description: 'Chatfire 统一网关（OpenAI 兼容格式，国内可用，代理 Gemini/OpenAI/MiniMax/火山等）',
    ...
    },
    {
      ...
      availableModels: [
        { id: 'gemini-3-pro-image-preview', name: 'Gemini 3 Pro Image', tags: ['最新'] },
        { id: 'gemini-3.1-flash-image-preview', name: 'Gemini 3.1 Flash Image', tags: ['最新', '快速'] },
        { id: 'gemini-2.5-flash-preview-image-generation', name: 'Gemini 2.5 Flash Image' },
    ...
    },
    {
      ...
      availableModels: [
        { id: 'doubao-seedream-4-5-251128', name: 'Seedream 4.5', tags: ['推荐', '最新'] },
  ...
  video: [
    {
      ...
      envKey: 'MINIMAX_API_KEY',
      availableModels: [
        { id: 'MiniMax-Video-01', name: 'Video-01 图生视频', tags: ['推荐'] },
        { id: 'Video-01-live', name: 'Video-01 Live 直播', tags: ['直播'] },
    ...
    },
    {
      ...
      envKey: 'ALI_API_KEY',
      availableModels: [
        { id: 'wan2.7-t2v', name: '万相 2.7 T2V', tags: ['推荐', '最新'] },
        { id: 'wan2.7-i2v', name: '万相 2.7 I2V', tags: ['最新'] },
        { id: 'wan2.7-r2v', name: '万相 2.7 R2V 参考视频', tags: ['最新'] },
        { id: 'wan2.6-i2v-flash', name: '万相 2.6 I2V Flash', tags: ['快速'] },
        { id: 'wan2.6-t2v', name: '万相 2.6 T2V' },
        { id: 'wan2.2-i2v-plus', name: '万相 2.2 I2V Plus', tags: ['高清'] },
        { id: 'wan2.2-i2v-flash', name: '万相 2.2 I2V Flash', tags: ['快速'] },
        { id: 'wan2.1-i2v-turbo', name: '万相 2.1 I2V Turbo' },
        { id: 'wan2.1-t2v-turbo', name: '万相 2.1 T2V Turbo' },
      ],
    },
    {
      provider: 'custom',
